...
the original message contained by the original .lz77 compressed file. Figure 33
...
addition, the program will display the parse tree of the balanced SLP. Figure 34
...
*exampleOutputGrammar.txt*, shown by Figure 35.
...
parse tree of the loaded grammar. Figure 37 displays the parse tree of the
loaded grammar from *exampleGrammar.txt*.
...
Figure 38 to Figure 40 shows our original grammar, from *exampleGrammar.txt*,
...
of the G-factors of the inputted grammar. Figure 41 displays the G-factors for
*exampleGrammar.txt*.
